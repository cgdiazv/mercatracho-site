...
export default function Weather() {
  // En el futuro, aquí harías un fetch a la API de clima
  const temp = "32"; // San Pedro Sula suele ser caluroso
  
  return (
    <div className="flex items-center gap-2 bg-[#f5f6f7] px-3 py-1.5 rounded-full border border-[#ebf0f6]">
      <span className="text-[11px] font-bold text-[#222222] uppercase tracking-wider">SPS</span>
      <div className="h-3 w-[1px] bg-gray-300"></div>
      <span className="text-[12px] font-bold text-[#2175eb]">{temp}°C</span>
      {/* Icono de sol sutil */}
